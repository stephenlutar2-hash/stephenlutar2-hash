...
const platforms: PlatformNode[] = [
  ...
  { id: "inca", name: "INCA", description: "Network configuration and automation", icon: Layers, color: "#10b981", status: "In Development", category: "Infrastructure", href: "/apps-showcase/", x: 0.65, y: 0.45 },
  ...
  { id: "lyte", name: "Lyte", description: "Lightweight analytics and performance monitoring", icon: Lightbulb, color: "#84cc16", status: "In Development", category: "Analytics", href: "/apps-showcase/", x: 0.7, y: 0.8 },
