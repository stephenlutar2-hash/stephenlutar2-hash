    ...
    <div className="min-h-screen bg-[#0a0a12] flex items-center justify-center px-4" style={{ backgroundImage: "radial-gradient(ellipse at center, rgba(139,92,246,0.05) 0%, transparent 70%)" }}>
      <div className="w-full max-w-md">
        ...
        <div className="bg-white/5 backdrop-blur-xl border border-violet-500/20 rounded-2xl p-8 space-y-6">
          ...
          <button
            onClick={() => {
              localStorage.setItem("szl_token", "demo_token_nimbus");
              localStorage.setItem("szl_user", "demo");
              localStorage.setItem("szl_demo_mode", "true"); trackEvent("demo", "enter", "nimbus");
              setLocation("/dashboard");
            }}
            className="w-full border border-violet-500/30 text-violet-400 font-semibold py-3 rounded-lg tracking-wide text-sm hover:bg-violet-500/10 transition"
          >
            Explore Demo
          </button>
