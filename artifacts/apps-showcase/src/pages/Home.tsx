...
const platforms = [
  ...
  },
  {
    ...
    description: "Environmental impact tracking and sustainability project management. Monitor carbon emissions, resource usage, and green initiative progress.",
    icon: Leaf,
    color: "from-emerald-500 to-green-600",
    accent: "emerald",
    features: ["Carbon Tracking", "Resource Monitoring", "Project Management", "Impact Reports"],
    path: "/lutar/",
  },
  {
    name: "Nimbus",
  ...
  {
    name: "Firestorm",
    tagline: "Offensive Security Operations",
    description: "Advanced penetration testing and offensive security toolkit for simulating real-world attack scenarios and identifying security gaps.",
    icon: Flame,
    color: "from-orange-500 to-red-600",
    accent: "orange",
    features: ["Penetration Testing", "Attack Simulation", "Vulnerability Exploitation", "Red Team Ops"],
    path: "/firestorm/",
  },
  {
    name: "DreamEra",
...
const tiers = [
  {
    ...
    features: ["ROSIE Basic Monitoring", "Beacon KPI Dashboard", "Lutar Environmental Tracking", "Email Support", "5 Team Members"],
  ...
  },
  {
    ...
    features: ["All Starter Features", "Aegis Security Suite", "Nimbus Predictions", "Firestorm Pen Testing", "Alloy AI Assistant", "Priority Support", "25 Team Members", "API Access"],
